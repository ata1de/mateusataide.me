...
const GridLayout = () => {
  ...
  return (
    <div className="grid grid-cols-12 md:grid-rows-12 gap-4 md:max-h-[500px] w-full">
      ...
      <div data-aos="flip-left" data-aos-duration='5000' className="col-span-12 md:col-span-5 md:row-span-12 relative rounded-3xl overflow-hidden">

        <Link href={`${currentLocale}/projects/arkan-seguros`} className="col-span-12 md:col-span-3 md:row-span-2 text-white rounded-3xl flex items-center justify-center">
      ...
      <div data-aos="flip-left" data-aos-duration='5000' className="col-span-12 md:col-span-4 md:row-span-4 text-black rounded-3xl relative">
        <Link href={`${currentLocale}/projects/ecommerce-store`} className="col-span-12 md:col-span-3 md:row-span-2 text-white rounded-3xl flex items-center justify-center">
