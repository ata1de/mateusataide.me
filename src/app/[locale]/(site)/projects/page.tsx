    ...
    return (
        <div className="w-full flex justify-center items-center mt-9 mb-8">
            <div className="max-w-[1056px] mx-auto px-4">
                <div className="flex-col gap-2 flex mb-2 max-[430px]:items-center">
                    <SlideIn>
                        <p className="text-4xl font-semibold pb-2">{t('title')}</p>
                    </SlideIn>
                    <SlideIn delay={0.5}>
                        <p className="text-lg text-wrap text-[rgb(109,109,109)] pb-2 flex max-[430px]:items-center justify-start">{t('description')}</p>
                    </SlideIn>
                </div>
